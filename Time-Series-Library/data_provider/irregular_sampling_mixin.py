...
def get_irregular_item(data_x, data_y, data_stamp, timestamps, observation_mask,
    ...
    if irregular_sampling != 'none':
        ...
        # Regular sampling - also return timestamps for time-based positional encodings
        ...
        # Get timestamps for observed data
        x_timestamps = pd.to_datetime(timestamps[s_begin:s_end])
        y_timestamps = pd.to_datetime(timestamps[r_begin:r_end])
